...
export default function ProcessSection() {
  ...
  return (
    <motion.section
      ...
      initial={{ backgroundColor: '#BFAF96' }}
      whileInView={{ backgroundColor: '#EAE3D9' }}
    ...
    >
      <div className="editorial-shell">
        ...
        >
          ...
          <motion.h2
            className="font-bodoni text-4xl sm:text-6xl lg:text-7xl text-[var(--color-charcoal)] font-normal tracking-tight leading-tight"
            variants={fadeUp}
          >
            <span className="lowercase">from vision to reality</span>
          </motion.h2>
          <motion.div
          ...
          />
          <motion.p
            className="max-w-md text-xs sm:text-sm font-helvetica text-[var(--color-warm-grey)] leading-relaxed font-light"
            variants={fadeUp}
          >
